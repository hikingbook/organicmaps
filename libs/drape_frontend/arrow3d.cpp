                                            ...
                                            ref_ptr<dp::TextureManager> texMng)
{
                ...
                [&](std::vector<float> positions, std::vector<float> normals, std::vector<float> texCoords)
  {
    ...
    if (positions.empty()) {
        LOG(LWARNING, ("Use the default arrow because the arrow mesh's positions are empty at the path: ", meshPath));
        positions = {0, 0, -0.5, -1.2, -1, 0, 0, 2, 0, 0, 0, -0.5, 0, 2, 0, 1.2, -1, 0, 0, 0, -0.5, 0, -0.5, 0, -1.2, -1, 0, 0, 0, -0.5, 1.2, -1, 0, 0, -0.5, 0};
        normals = {-0.745356, 0.298142, -0.596285, -0.745356, 0.298142, -0.596285, -0.745356, 0.298142, -0.596285, 0.745356, 0.298142, -0.596285, 0.745356, 0.298142, -0.596285, 0.745356, 0.298142, -0.596285, 0.349215, -0.838116, -0.419058, 0.349215, -0.838116, -0.419058, 0.349215, -0.838116, -0.419058, -0.349215, -0.838116, -0.419058, -0.349215, -0.838116, -0.419058, -0.349215, -0.838116, -0.419058};
    }
    if (!positions.empty())
    {
      if (normals.empty())
