...
public:
  ...
  // StoreInterface overrides:
  Country * InsertToCountryTree(CountryId const & id, MwmSize /* mapSize */, string const & /* mapSha1 */, MwmSize /* hikingbookProMapSize */,
                                string const & /* hikingbookProMapSha1 */, size_t /* depth */, CountryId const & /* parent */) override
  {
    CountryInfo info(id);
