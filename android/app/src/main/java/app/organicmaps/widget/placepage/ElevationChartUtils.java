...
public final class ElevationChartUtils
{
  ...
  private static void setupCommon(@NonNull LineChart chart, @NonNull Context context, int topOffset, int xLabelCount)
  {
    ...
    chart.setRenderer(new LineChartRenderer(chart, chart.getAnimator(), chart.getViewPortHandler()));
...
//    DefaultValueFormatter xAxisFormatter = new AxisValueFormatter(chart);
