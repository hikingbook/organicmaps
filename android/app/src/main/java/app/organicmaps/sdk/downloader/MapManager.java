...
public final class MapManager
{
  ...
  public static boolean warn3gAndDownload(Activity activity, final String countryId, final MapSource mapSource,
  ...
  public static boolean warn3gAndRetry(Activity activity, final String countryId, final MapSource mapSource,
                                       @Nullable final Runnable onAcceptListener)
  {
    return warnOn3g(activity, countryId, () -> {
      if (onAcceptListener != null)
